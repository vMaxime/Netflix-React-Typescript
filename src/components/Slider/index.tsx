...
const Slider: FC<PropsWithChildren<SliderProps>> = ({ children, buttonsBackground }) => {
        ...
        <div className="slider" ref={sliderRef}>
            {
                ...
                <button ref={buttonRef} className="move-right" onClick={moveRight} style={{ background: buttonsBackground || 'linear-gradient(270deg,#141414 0,hsla(0,0%,8%,.4))' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
