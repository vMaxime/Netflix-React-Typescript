...
function Profile() {
    ...
    <main className={newProfile === null ? "block" : "flex"} style={{ backgroundColor: '#141414' }}>
    {
        ...
        ?
                ...
                <ul className="flex flex-wrap gap-x-5">
                    {
                        profiles.map(profile => 
                            <li key={profile.name} className={'profile' + (managing ? ' managing' : '')} onClick={() => setCurrentProfile(profile)}>
            ...
            :
            <EditProfile profile={currentProfile} handleCancel={() => setCurrentProfile(null)} onSaved={() => setCurrentProfile(null)} />
        :
